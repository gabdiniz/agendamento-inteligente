// ─── Patient Login Page (e-mail/senha) ───────────────────────────────────────
//
// Login secundário do portal do paciente — e-mail + senha.
// Padrão visual idêntico ao PatientOtpLoginPage.
// Rota: /:slug/minha-conta/login-email
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              ...
              <div style={{ position: 'relative' as const }}>
                ...
                <button type="button" onClick={() => setShowPw(!showPw)} aria-label={showPw ? 'Ocultar senha' : 'Mostrar senha'}
                  style={{ position: 'absolute' as const, right: '12px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: '#b0a899', padding: '4px' }}>
                  {showPw ? (
            ...
            <div style={{ textAlign: 'right', marginTop: '-4px' }}>
              <Link to="/$slug/minha-conta/esqueci-senha" params={{ slug }}
        ...
        {/* Voltar para WhatsApp (login padrão) */}
