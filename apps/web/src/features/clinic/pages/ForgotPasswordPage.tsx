// ─── Clinic Forgot Password Page ─────────────────────────────────────────────
//
// Formulário para solicitar e-mail de recuperação de senha.
// Padrão visual idêntico ao ClinicLoginPage (banner + grain + warm palette).
    ...
    <div style={{
      ...
      <div style={{
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                ...
                <input
                  type="email" autoComplete="email" placeholder="voce@clinica.com"
                  {...register('email')}
                  style={{
                    ...inputBase,
        ...
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
          <Link to="/app/$slug/login" params={{ slug }}
